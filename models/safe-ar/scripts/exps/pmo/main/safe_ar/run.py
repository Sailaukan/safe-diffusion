...
class SafeAROptimizer(BaseOptimizer):
    def __init__(self, args=None):
        super().__init__(args)
        self.model_name = 'SAFE-AR'
    ...
    def _optimize(self, oracle, config):
        ...
        SafeAROpt(config, self.oracle).run()
...
class SafeAROpt:
    def __init__(self, args, oracle):
        ...
        self.fname = f'main/safe_ar/results/{args.oracle_name}_{args.seed}.csv'
