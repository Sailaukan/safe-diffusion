...
- `src/genmol/`: the installable SAFE-MDLM Python package. Core model code lives in `model.py`, diffusion logic in `diffusion.py`, sampling in `sampler.py`, and shared helpers under `utils/`.
