...
class SafeMDLMOptimizer(BaseOptimizer):
    def __init__(self, args=None):
        super().__init__(args)
        self.model_name = 'SAFE-MDLM'
    ...
    def _optimize(self, oracle, config):
        ...
        SafeMDLMOpt(config, self.oracle).run()
...
class SafeMDLMOpt():
    def __init__(self, args, oracle):
        ...
        self.fname = f'main/safe_mdlm/results/{args.oracle_name}_{args.seed}.csv'
