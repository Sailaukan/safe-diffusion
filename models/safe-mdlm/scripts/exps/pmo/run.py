...
from scripts.exps.pmo.main.safe_mdlm.run import SafeMDLMOptimizer as Optimizer
...
def main():
    ...
    path_main = os.path.join(path_main, 'main/safe_mdlm')
    ...
    if not os.path.exists(config_path):
        config_path = os.path.join(path_main, args.config)
